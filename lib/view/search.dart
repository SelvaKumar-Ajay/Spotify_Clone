  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
          ...
          children: [
            titleText(text: StringConstants.search, width: width),
            Row(
              children: [
                Container(
                  ...
                  width:
                      SearchSizes(height: height, width: width).containerwidth,
                  child: Row(
                    children: [
                      Padding(
                ...
                Image.asset(
                  ...
                  color: whiteColor,
                  height:
                      SearchSizes(height: height, width: width).micIconHeight,
